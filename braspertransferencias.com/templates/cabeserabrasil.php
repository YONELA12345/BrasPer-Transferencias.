...
<center>
          <div class="popup">
                <div>
                    <div>
                        <img src="{{url_for('static',filename='img/padre_br.png')}}" style="width:100%;">
                    </div>
                    <div id="btn-cerrar">
                        X<p>CERRAR</p>
                    </div>
...
<div class='txtroboto cbesas'>
    ...
    <div class="contxtmenu" id="contxtmenu">
                <div>&nbsp;</div>
                <div><a hef="#">Inicio</a></div>
                <div><a href="#somosperu">&iquest;Quem somos&#63;</a></div>
                <div><a href="#iniciopasos">&iquest;Como Funciona&#63;</a></div>
